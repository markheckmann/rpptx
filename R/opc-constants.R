...
# Translated from python-pptx: pptx/opc/constants.py


# CT - Content type URIs (like MIME-types) that specify a part's format --------
...
# NS - Constant values for OPC XML namespaces ---------------------------------
...
# RTM - Open XML relationship target modes ------------------------------------
