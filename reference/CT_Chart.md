...
- [`CT_Chart$get_or_add_title()`](#method-CT_Chart-get_or_add_title)

- [`CT_Chart$get_or_add_autoTitleDeleted()`](#method-CT_Chart-get_or_add_autoTitleDeleted)

- [`CT_Chart$.remove_title()`](#method-CT_Chart-.remove_title)

- [`CT_Chart$.add_legend()`](#method-CT_Chart-.add_legend)

- [`CT_Chart$.remove_legend()`](#method-CT_Chart-.remove_legend)

- [`CT_Chart$clone()`](#method-CT_Chart-clone)
...
### Method `get_or_add_title()`

#### Usage

    CT_Chart$get_or_add_title()

------------------------------------------------------------------------

### Method `get_or_add_autoTitleDeleted()`

#### Usage

    CT_Chart$get_or_add_autoTitleDeleted()
...
### Method `.remove_legend()`

#### Usage

    CT_Chart$.remove_legend()
