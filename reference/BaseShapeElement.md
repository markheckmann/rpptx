...
Provides position, size, rotation, shape ID/name, and placeholder
detection via active bindings that delegate through the element's shape
properties.
...
- [`BaseShapeElement$get_or_add_xfrm()`](#method-BaseShapeElement-get_or_add_xfrm)

- [`BaseShapeElement$get_or_add_ln()`](#method-BaseShapeElement-get_or_add_ln)

- [`BaseShapeElement$clone()`](#method-BaseShapeElement-clone)
...
### Method `get_or_add_xfrm()`

#### Usage

    BaseShapeElement$get_or_add_xfrm()

------------------------------------------------------------------------

### Method `get_or_add_ln()`

#### Usage

    BaseShapeElement$get_or_add_ln()
...
#### Usage
    ...
    BaseShapeElement$clone(deep = FALSE)
