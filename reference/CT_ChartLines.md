...
- [`CT_ChartLines$get_or_add_spPr()`](#method-CT_ChartLines-get_or_add_spPr)

- [`CT_ChartLines$clone()`](#method-CT_ChartLines-clone)
...
#### Usage
    ...
    CT_ChartLines$clone(deep = FALSE)
