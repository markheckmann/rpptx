...
- [`CT_Layout$get_or_add_manualLayout()`](#method-CT_Layout-get_or_add_manualLayout)

- [`CT_Layout$clone()`](#method-CT_Layout-clone)
...
### Method `get_or_add_manualLayout()`

#### Usage

    CT_Layout$get_or_add_manualLayout()
