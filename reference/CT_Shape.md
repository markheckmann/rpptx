...
- [`CT_Shape$_new_txBody()`](#method-CT_Shape-_new_txBody)

- [`CT_Shape$add_path()`](#method-CT_Shape-add_path)

- [`CT_Shape$_insert_txBody()`](#method-CT_Shape-_insert_txBody)

- [`CT_Shape$_add_txBody()`](#method-CT_Shape-_add_txBody)

- [`CT_Shape$get_or_add_txBody()`](#method-CT_Shape-get_or_add_txBody)

- [`CT_Shape$_remove_txBody()`](#method-CT_Shape-_remove_txBody)

- [`CT_Shape$clone()`](#method-CT_Shape-clone)
...
#### Usage
    ...
    CT_Shape$add_path(w, h)

------------------------------------------------------------------------

### Method `_insert_txBody()`

#### Usage

    CT_Shape$_insert_txBody(child)
...
#### Usage
    ...
    CT_Shape$_add_txBody(...)

------------------------------------------------------------------------

### Method `get_or_add_txBody()`

#### Usage

    CT_Shape$get_or_add_txBody()

------------------------------------------------------------------------

### Method `_remove_txBody()`

#### Usage

    CT_Shape$_remove_txBody()
