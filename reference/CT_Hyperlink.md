...
- [`CT_Hyperlink$action_fields()`](#method-CT_Hyperlink-action_fields)

- [`CT_Hyperlink$action_verb()`](#method-CT_Hyperlink-action_verb)

- [`CT_Hyperlink$clone()`](#method-CT_Hyperlink-clone)
...
### Method `action_fields()`

#### Usage

    CT_Hyperlink$action_fields()
