...
- [`CT_Legend$get_or_add_legendPos()`](#method-CT_Legend-get_or_add_legendPos)

- [`CT_Legend$get_or_add_overlay()`](#method-CT_Legend-get_or_add_overlay)

- [`CT_Legend$.remove_overlay()`](#method-CT_Legend-.remove_overlay)

- [`CT_Legend$get_or_add_layout()`](#method-CT_Legend-get_or_add_layout)

- [`CT_Legend$get_or_add_txPr()`](#method-CT_Legend-get_or_add_txPr)

- [`CT_Legend$clone()`](#method-CT_Legend-clone)
...
### Method `get_or_add_legendPos()`

#### Usage

    CT_Legend$get_or_add_legendPos()

------------------------------------------------------------------------

### Method `get_or_add_overlay()`

#### Usage

    CT_Legend$get_or_add_overlay()
...
#### Usage
    ...
    CT_Legend$.remove_overlay()

------------------------------------------------------------------------

### Method `get_or_add_layout()`

#### Usage

    CT_Legend$get_or_add_layout()

------------------------------------------------------------------------

### Method `get_or_add_txPr()`

#### Usage

    CT_Legend$get_or_add_txPr()
