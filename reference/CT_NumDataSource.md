...
- [`CT_NumDataSource$pt_v()`](#method-CT_NumDataSource-pt_v)

- [`CT_NumDataSource$clone()`](#method-CT_NumDataSource-clone)
...
#### Usage
    ...
    CT_NumDataSource$clone(deep = FALSE)
