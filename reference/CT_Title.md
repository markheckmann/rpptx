...
- [`CT_Title$get_or_add_tx()`](#method-CT_Title-get_or_add_tx)

- [`CT_Title$get_or_add_tx_rich()`](#method-CT_Title-get_or_add_tx_rich)

- [`CT_Title$.remove_tx()`](#method-CT_Title-.remove_tx)

- [`CT_Title$get_or_add_spPr()`](#method-CT_Title-get_or_add_spPr)

- [`CT_Title$clone()`](#method-CT_Title-clone)
...
### Method `get_or_add_tx()`

#### Usage

    CT_Title$get_or_add_tx()

------------------------------------------------------------------------

### Method `get_or_add_tx_rich()`

#### Usage

    CT_Title$get_or_add_tx_rich()
...
### Method `get_or_add_spPr()`

#### Usage

    CT_Title$get_or_add_spPr()
