...
- [`CT_DPt$get_or_add_spPr()`](#method-CT_DPt-get_or_add_spPr)

- [`CT_DPt$get_or_add_marker()`](#method-CT_DPt-get_or_add_marker)

- [`CT_DPt$clone()`](#method-CT_DPt-clone)
...
#### Usage
    ...
    CT_DPt$get_or_add_spPr()

------------------------------------------------------------------------

### Method `get_or_add_marker()`

#### Usage

    CT_DPt$get_or_add_marker()
